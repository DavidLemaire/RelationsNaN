...
namespace RelationsNaN.Controllers
{
    public class GamesController : Controller
    {
        ...
        {
            var relationsNaNContext = _context.Game.Include(g => g.Genre).Include(g => g.Plateforms);
        ...
        private void AddPlateform(int PId, int GId)
        {
            Plateform plateform = _context.Plateform.Find(PId);
            Game game = _context.Game.Find(GId);

            game.Plateforms.Add(plateform);
            _context.SaveChanges();
        }
        private void RemovePlateform(int PId, int GId)
        {
            Plateform plateform = _context.Plateform.Find(PId);
            Game game = _context.Game.Find(GId);

            game.Plateforms.Remove(plateform);
            _context.SaveChanges();
        }
    }
}
